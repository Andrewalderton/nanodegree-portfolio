  ...
  return $.fn.reportCard = function(options) {
    ...
    ReportCard = (function() {
      ...
      ReportCard.prototype.build = function(data) {
        ...
        html = "<img src=\"img/treehouse-logo.png\" class=\"th-logo\"><h2>I have passed " + data.badge_count + " lessons and scored " + (toThousands(data.points_total)) + " points at " + data.site + "!</h2>\n<p class=\"featured-text\">Check out some of my latest passed courses at the badges below: </p>\n<ul class=\"badges\">";
